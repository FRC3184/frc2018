...
class ScaleOnly(CommandGroup):
    def __init__(self, drive: Drivetrain, elevator: Elevator, intake: Intake):
        ...
        close_waypoints = [Vector2(0, 0), Vector2(16, 0), Vector2(22, 2)]
        far_waypoints = [Vector2(0, 0), Vector2(19, 0), Vector2(19, 16.5), Vector2(22.75, 16)]
        cruise = 0.6
        acc = 0.6
        margin = 3/12
        lookahead = 2
        ...
        drive_path_chooser.onFalse = drive_path_close
        drive_path_chooser.onTrue = drive_path_far
